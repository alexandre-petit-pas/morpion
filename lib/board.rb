...
class Board
    ...
    def initialize
        ...
        @array_case = [[@case1, @case2, @case3],[@case4, @case5, @case6],[@case7, @case8, @case9]] #Puis on range ces 9 cases dans un array dédié, qu'on a aussi défini en attr_accessor
    end
    ...
    def victory?
      ...
      #Les cas possibles de victoire
        ...
        true #Si il y a une victoire, on retourne true
      else
